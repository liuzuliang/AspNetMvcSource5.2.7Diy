...
namespace AspNetMvcSourceDiySample.Extensions.ModelBinders.DynGrid
{
    public interface IDynamicGridSetting
    {
        ...
        /// </summary>
        string ElementNameFormat { get; set; }
        ...
        /// </summary>
        string FormatSeparator { get; set; }

        /// <summary>
        /// 获取或设置如果它作用的 Property 的类型是枚举类型，那么是否启用大小写敏感来获取表单或 QueryString 的值。默认为 false，即不区分大小写。
        /// </summary>
        bool IfContainsEnumTypeThenEnableCaseSensitive { get; set; }
    }
}
